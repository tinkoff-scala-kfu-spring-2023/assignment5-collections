...
* Объяснить, какая сложность по памяти и времени у 1 решение, и как были достигнуты необходимые лимиты по времени и памяти во втором. **Отдельным  файлом complexity.md в корне папки проекта**
